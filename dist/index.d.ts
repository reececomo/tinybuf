 ...
 */
export declare function defineFormat<T extends EncoderDefinition, HeaderType extends string | number = number>(def: T): BinaryCoder<T, HeaderType>;
/**
 * Defines a format for encoding/decoding binary buffers.
 *
 * Optionally customize the identifier, either as a 2-byte string, an unsigned integer (0 -> 65,535), or as `null` to disable entirely.
 ...
 * const MyFormat = defineFormat(null, { ... });
 */
export declare function defineFormat<T extends EncoderDefinition, HeaderType extends string | number = number>(h: HeaderType | null, def: T): BinaryCoder<T, HeaderType>;
declare class BinaryCoder<EncoderType extends EncoderDefinition, HeaderType extends FormatHeader = number> {
	/**
...
export type AnyFormat = BinaryCoder<any, any>;
/**
...
declare class BufferParser {
	 ...
	 */
	on<EncoderType extends EncoderDefinition, DecodedType = InferredDecodedType<EncoderType>>(format: BinaryCoder<EncoderType, string | number>, callback: (data: DecodedType) => any, overwritePrevious?: boolean): this;
